...
'''
VA.model(TEST=False, targeting=False, latent_number=32, optimizer_selection="Adam", \
         learning_rate=0.001, training_epochs=100, batch_size=512, display_step=1, batch_norm=True)
