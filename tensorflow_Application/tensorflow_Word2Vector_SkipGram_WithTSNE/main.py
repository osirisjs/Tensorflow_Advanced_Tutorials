...
Word2Vec(TEST=True, tSNE=True, model_name="Word2Vec", weight_selection="decoder",  # encoder or decoder
         vocabulary_size=10000, tSNE_plot=200, similarity_number=8,
         ...
         negative_sampling=64, optimizer_selection="SGD", learning_rate=0.1, training_epochs=1,
         display_step=1, weight_sharing=True)
